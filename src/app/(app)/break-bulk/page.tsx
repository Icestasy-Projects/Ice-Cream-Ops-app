...
export default function BreakBulkPage() {
  ...
  async function handleSubmit() {
    ...
    if (tubsNum > selected.qty_on_hand) {
      toast.error(`Only ${formatNumber(litresToUnits(selected.qty_on_hand, selected.unit), 2)} Bulks in stock.`);
      return;
    }
              ...
              <div key={s.fg_sku_id}>
                ...
                >
                  ...
                  <span className="text-sm font-bold text-gray-700 shrink-0">
                    {formatNumber(litresToUnits(s.qty_on_hand, s.unit), 2)} Bulks
                  </span>
                </button>
                  ...
                  <div className="border-2 border-t-0 border-brand-500 bg-orange-50 rounded-b-2xl px-4 pb-4 pt-3 space-y-4">
                    <div>
                      <label className="label-text block mb-1">
                        Number of Bulks to open (max {formatNumber(litresToUnits(s.qty_on_hand, s.unit), 2)})
                      </label>
                      <input
